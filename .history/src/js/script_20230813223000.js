...
swiperSlides.forEach(slide => {
  if (window.innerWidth <= 767) { // 画面幅が767px以下の場合に適用
    mainSwiper.params.slidesPerView = 1.5; // Swiperのオプションを変更
    slide.style.width = "280px";
    slide.style.marginRight = "24px";
  } else {
    mainSwiper.params.slidesPerView = 1; // 元のオプションに戻す
    slide.style.width = "333px";
    slide.style.marginRight = "40px";
  }
  mainSwiper.update(); // Swiperを更新して変更を反映
});
